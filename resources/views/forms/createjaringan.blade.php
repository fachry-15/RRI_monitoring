    ...
    <div class="p-6 sm:ml-64 bg-gray-100 min-h-screen mt-14">
        <div class="w-full mx-auto">
            ...
            <section class="w-full px-6 mx-auto lg:px-12">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-4">Tambah Data Router</h1>
                <p class="text-gray-600 dark:text-gray-300 mb-6">
                    Silakan isi formulir di bawah ini untuk menambahkan data router baru.
                </p>

                <!-- Form Tambah Router -->
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
                    <form method="POST" action="{{ route('jaringan.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nama_router" name="nama" required 
                        ...
                        <!-- Input IP Router -->
                        <div class="mb-4">
                            <label for="ip_router" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                IP Router
                            </label>
                            <input type="text" id="ip_router" name="ip" required pattern="^(\d{1,3}\.){3}\d{1,3}$"
                                class="block w-full p-3 text-sm border border-gray-300 rounded-md bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukkan IP router (contoh: 192.168.1.1)">
                        </div>
