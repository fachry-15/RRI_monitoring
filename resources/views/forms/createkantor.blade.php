    ...
    <div class="p-6 sm:ml-64 bg-gray-100 min-h-screen mt-14">
        <div class="w-full mx-auto">
            ...
            <section class="w-full px-6 mx-auto lg:px-12">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-4">Tambah kantor Baru</h1>
                <p class="text-gray-600 dark:text-gray-300 mb-8">
                    Silakan isi form di bawah ini untuk menambahkan kantor baru ke dalam daftar.
                </p>
