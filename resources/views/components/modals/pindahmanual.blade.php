    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-6">
            <form action="{{ route('peminjaman.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="kegiatan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                        Acara/Kegiatan
                    </label>
                    <input type="text" id="acara" name="kegiatan"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        placeholder="Masukkan kegiatan" value="" required>
                </div>
                <div class="mb-4">
                    <label for="tanggalDigunakan"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                        Tanggal Digunakan
                    </label>
                    <input type="date" name="tanggal_kegiatan" id="tanggal"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        required value="">
                </div>
                <div class="mb-4">
                    <label for="jamMulai" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                        Jam Mulai
                    </label>
                    <input type="text" name="jam_mulai" id="mulai"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        required>
                </div>
                <div class="mb-4">
                    <label for="jamSelesai" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                        Jam Selesai
                    </label>
                    <input type="text" name="jam_selesai" id="selesai"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        required>
                </div>
